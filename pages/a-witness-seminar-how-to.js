...
export default function Home() {
	let url = 'https://value-parser.herokuapp.com/scrap';
						...
						<section className={styles.centeredElements}>
                            ...
                            <div><a href="./"
                                ...
                                Back
									...
									<p className={styles.titlewitness}>Past Seminars</p>
									...
									<div className={styles.contentparagraph}>
										<p>
											...
											specific formation? (with specific attention to imagining
											a legal system rooted in a more-than-human ecological
											paradigm). If we imagine that each participant is invited
											to speak on behalf of a layer of the stratified seabed.
											The archived layers are distributed accross phosphate,
											carbon, fish, and salt, and aim to bring into dicussion
											possible attunement through a grounding in Seili. What
											post-extractive futures can we imagine through this
											specific formation? (with specific attention to imagining
											a legal system rooted in a more-than-human ecological
											paradigm).
